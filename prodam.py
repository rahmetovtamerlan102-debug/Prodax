...
body {
    ...
    background: radial-gradient(ellipse at 30% 40%, #0a0a2a, #050510);
    color: #fff;
    min-height: 100vh;
    padding: 20px;
}
    ...
    document.getElementById('shop-view').innerHTML = `
        <div class="card">
            <div class="payment-header">
                ...
                <div style="background:rgba(168,85,247,0.15); border-radius:16px; padding:12px; margin-top:10px">
                    👤 <strong>${displayName}</strong>
                </div>
            </div>
            <div class="requisites">
                <div class="requisite-row"><span>🏦 Банк:</span><span>Т-Банк</span></div>
                <div class="card-number" onclick="copyCard()">2200 7021 5075 4195</div>
                <div class="requisite-row"><span>👤 Получатель:</span><span>Мухаммад А</span></div>
            </div>
            <div class="upload-area" onclick="document.getElementById('screenshotInput').click()">
                📸 <span id="uploadText">Прикрепить скриншот оплаты</span>
            ...
            <button class="btn btn-secondary" style="margin-top:12px" onclick="goBack()">◀ Назад</button>
        </div>
    `;
}
