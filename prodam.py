...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        .user-info { background: rgba(168,85,247,0.2); border-radius: 16px; padding: 12px; margin: 15px 0; text-align: center; border: 1px solid rgba(168,85,247,0.3); }
        .user-info span { color: #c084fc; font-weight: bold; }
